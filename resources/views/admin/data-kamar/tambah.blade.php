    ...
    <div class="card-body">
        <form action="{{ route('admin.data-kamar.store') }}" enctype="multipart/form-data" method="POST">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control @error('deskripsi_singkat') is-invalid @enderror" cols="2" placeholder="Masukan deskripsi singkat kamar..." name="deskripsi_singkat">{{ old('deskripsi_singkat') }}</textarea>
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control editor @error('deskripsi_kamar') is-invalid @enderror" placeholder="Masukan deskripsi kamar..." name="deskripsi_kamar">{{ old('deskripsi_kamar') }}</textarea>
