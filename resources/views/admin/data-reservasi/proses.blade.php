...
<div class="card col-lg-9 mb-4">
    ...
    <div class="card-body">
        ...
        <div class="row mb-2">
            ...
            <div class="col-lg-6 text-end">
                (ID : {{ $data_reservasi->id_user }}) {{ $data_reservasi->user->nama }}&nbsp;&nbsp;&nbsp;<a href="{{ route('admin.data-user.edit', [$data_reservasi->id_user]) }}" class="btn btn-primary btn-sm"><i class="fas fa-file"></i>&nbsp;&nbsp;Cek Data</a>
            </div>
        </div>
        <div class="row mb-2">
            <div class="col-lg-6">
        ...
        <div class="col-lg-12 text-end">
            ...
            @if($data_reservasi->status_reservasi == "Siap di Check-in")
                <a href="{{ route('admin.data-reservasi.checkInAll', [$data_reservasi->id]) }}" class="btn btn-primary">
            ...
            @if($data_reservasi->status_reservasi == "Sudah Check-in")
                <a href="{{ route('admin.data-reservasi.checkOutAll', [$data_reservasi->id]) }}" class="btn btn-success">
