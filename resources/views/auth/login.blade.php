...
<head>
    ...
    <title>Login - Admin Pererenan Nengah Guest House</title>
                    ...
                    <div class="card" style="border-radius: 1rem;">
                        <div class="row g-0">
                            <div class="col-md-6 col-lg-5 d-none d-md-block">
                                <img src="/asset-landing/img/img-cover-admin-login.jpg" alt="login form"
                            ...
                            <div class="col-md-6 col-lg-7 d-flex align-items-center">
                                <div class="card-body p-4 p-lg-5 text-black">
                                    ...
                                    <form method="POST" action="{{ route('login') }}">
                                        ...
                                        <h5 class="fw-normal mb-3 pb-3" style="letter-spacing: 1px;">Pererenan Nengah
                                            Guest House</h5>
